...
public class DiscreteTreeParser {
    ...
    private static final Integer UNRESOLVED_INDEX = Integer.MAX_VALUE;
        ...
        public void parseTree() throws IOException, ImportException, SpreadException {
        ...
        private String getNodeState(Node node) throws SpreadException {

                String nodeState = (String) ParsersUtils.getObjectNodeAttribute(node, locationTrait);
        ...
        private Point createPoint(Node node, Location location) throws SpreadException {

                Double height = ParsersUtils.getNodeHeight(this.rootedTree, node) * timescaleMultiplier;
                String startTime = timeParser.getNodeDate(height);
